    ...
    <div className="p-4 border-t border-gray-200">
      {user ? (
        <div className="bg-gray-100/50 rounded-2xl p-4">
          ...
          >
            {avatarUrl ? (
              ...
              <div className="w-full h-full flex flex-col items-center justify-center text-gray-500">
                ...
                <span className="text-[10px]">?¬ì§„ ?†ìŒ</span>
              </div>
            )}
          ...
          <div className="flex justify-between items-center">
            <div className="overflow-hidden">
              <p className="text-gray-800 text-sm font-bold truncate">{user.email.split('@')[0]}</p>
        ...
        <div className="bg-gray-100/50 rounded-2xl p-4 text-center">
          <p className="text-gray-500 text-sm mb-3">ë¡œê·¸?¸ì´ ?„ìš”?©ë‹ˆ??/p>
