/**
 * 범지구적 퍼즐 — 수도 시드 (소량).
 * #31 캠페인(아시아·남아메리카·오세아니아) 우선 + distractor용 소량.
 */
...
export const GLOBAL_PUZZLE_CAPITALS = [
  ...
  { id: 'fj', capitalKo: '수바', capitalEn: 'Suva' },
  { id: 'pg', capitalKo: '포트모르즈비', capitalEn: 'Port Moresby' },
  { id: 'sb', capitalKo: '호니아라', capitalEn: 'Honiara' },
  { id: 'vu', capitalKo: '포트빌라', capitalEn: 'Port Vila' },
  { id: 'to', capitalKo: '누쿠알로파', capitalEn: "Nuku'alofa" },
  { id: 'ws', capitalKo: '아피아', capitalEn: 'Apia' },
