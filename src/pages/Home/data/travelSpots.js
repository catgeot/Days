...
export const TRAVEL_SPOTS = [
  ...
  { 
    ...
    lat: 3.20, lng: 73.22, category: "paradise", videoId: "t-hfCwbVnrM",
    keywords: ["럭셔리", "신혼여행", "수중환경", "리조트"]
  },
  { 
    id: 107, name: "괌", name_en: "Guam", 
    country: "미국", country_en: "USA",
    lat: 13.44, lng: 144.79, category: "paradise", videoId: "scVZ8PWespo",
    keywords: ["가족여행", "쇼핑", "태교여행", "호캉스"]
  },
  { 
    id: 108, name: "칸쿤", name_en: "Cancun", 
    country: "멕시코", country_en: "Mexico",
    lat: 21.16, lng: -86.85, category: "paradise", videoId: "SxLA7ABzPi0",
  ...
  { 
    ...
    lat: 48.85, lng: 2.35, category: "urban", videoId: "my_7f-tY1tA",
    keywords: ["에펠탑", "쇼핑", "예술", "박물관", "카페"]
  },
  { 
    id: 304, name: "도쿄", name_en: "Tokyo", 
    country: "일본", country_en: "Japan",
    lat: 35.67, lng: 139.76, category: "urban", videoId: "ZzqN8lkNQ-I",
    keywords: ["쇼핑", "애니메이션", "스시", "야경", "거리"]
  },
  { 
    id: 303, name: "뉴욕", name_en: "New York", 
    country: "미국", country_en: "USA",
    lat: 40.71, lng: -74.00, category: "urban", videoId: "8B6FSEGY6Ko",
  ...
  { 
    ...
    lat: 16.05, lng: 108.20, category: "nearby", videoId: "g3xnCQmMdBc",
    keywords: ["가성비", "리조트", "가족여행", "베트남"]
  },
  { 
    id: 403, name: "오사카", name_en: "Osaka", 
    country: "일본", country_en: "Japan",
    lat: 34.69, lng: 135.50, category: "nearby", videoId: "OB1xShQERJ8",
    keywords: ["먹방", "유니버셜", "오사카성", "도톤보리"]
  },
  { 
    id: 405, name: "후쿠오카", name_en: "Fukuoka", 
    country: "일본", country_en: "Japan",
    lat: 33.59, lng: 130.40, category: "nearby", videoId: "MNHYBTnUeJI",
  ...
  { 
    ...
    lat: 25.03, lng: 121.56, category: "nearby", videoId: "WZp6d5BjfM4",
    keywords: ["야시장", "딤섬", "101타워", "근거리"]
  },
  { 
    id: 407, name: "홍콩", name_en: "Hong Kong", 
    country: "홍콩", country_en: "Hong Kong",
    lat: 22.31, lng: 114.16, category: "nearby", videoId: "H9mwbhJBUaw",
  ...
  { 
    ...
    lat: -2.33, lng: 34.83, category: "adventure", videoId: "yy6cLDf-rd8",
  ...
  { 
    ...
    lat: 30.04, lng: 31.23, category: "adventure", videoId: "mysTzRk7uqo",
