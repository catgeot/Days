...
// 2. [New] 기존 아시아 편중이던 'nearby' 카테고리를 'culture'(문화/역사)로 변경하여 전 지구적 랜드마크를 제공.
// 3. [Quality] 대륙별(북미, 남미, 유럽, 아프리카, 아시아, 오세아니아) 안배를 최우선으로 하여 줌인 시 편중 없는 시각적 밸런스 유지.

export const TRAVEL_SPOTS = [
  // ==========================================
  // 1. 💎 Paradise (휴양) - 전 세계 에메랄드 해변과 섬
  // ==========================================
  { 
    id: 101, name: "보라보라", name_en: "Bora Bora",
    country: "프랑스령 폴리네시아", country_en: "French Polynesia",
    lat: -16.50, lng: -151.74, category: "paradise", 
  ...
  { 
    id: 105, name: "세이셸", name_en: "Seychelles", 
    country: "세이셸", country_en: "Seychelles",
    lat: -4.67, lng: 55.49, category: "paradise", 
  ...
  { 
    id: 106, name: "페르난두지노로냐", name_en: "Fernando de Noronha", 
    country: "브라질", country_en: "Brazil",
    lat: -3.84, lng: -32.42, category: "paradise", 
  ...
  // ==========================================
  // 2. 🏔️ Nature (자연) - 대륙별 압도적인 대자연
  // ==========================================
  { 
    id: 201, name: "밴프 국립공원", name_en: "Banff National Park", 
    country: "캐나다", country_en: "Canada",
    lat: 51.17, lng: -115.57, category: "nature", 
  ...
  { 
    id: 203, name: "아이슬란드", name_en: "Iceland", 
  ...
  { 
    id: 205, name: "후지산", name_en: "Mount Fuji", 
    country: "일본", country_en: "Japan",
    lat: 35.36, lng: 138.72, category: "nature", 
  ...
  { 
    id: 206, name: "그레이트 배리어 리프", name_en: "Great Barrier Reef", 
    country: "호주", country_en: "Australia",
    lat: -18.28, lng: 147.69, category: "nature", 
  ...
  // ==========================================
  // 3. 🏙️ Urban (도시) - 대륙별 주요 메가시티
  // ==========================================
  { 
    id: 301, name: "뉴욕", name_en: "New York", 
  ...
  { 
    id: 302, name: "리우데자네이루", name_en: "Rio de Janeiro", 
    country: "브라질", country_en: "Brazil",
    lat: -22.90, lng: -43.17, category: "urban", 
  ...
  { 
    id: 304, name: "케이프타운", name_en: "Cape Town", 
    country: "남아프리카공화국", country_en: "South Africa",
    lat: -33.92, lng: 18.42, category: "urban", 
  ...
  { 
    id: 306, name: "시드니", name_en: "Sydney", 
    country: "호주", country_en: "Australia",
    lat: -33.86, lng: 151.20, category: "urban", 
  ...
  // ==========================================
  // 4. 🏛️ Culture (역사/문화) - 전 세계의 위대한 유산 (기존 Nearby 대체)
  // ==========================================
  { 
    id: 401, name: "치첸이트사", name_en: "Chichen Itza", 
    country: "멕시코", country_en: "Mexico",
    lat: 20.68, lng: -88.56, category: "culture", 
  ...
  { 
    id: 402, name: "마추픽추", name_en: "Machu Picchu", 
    country: "페루", country_en: "Peru",
    lat: -13.16, lng: -72.54, category: "culture", 
  ...
  { 
    id: 403, name: "로마", name_en: "Rome", 
    country: "이탈리아", country_en: "Italy",
    lat: 41.90, lng: 12.49, category: "culture", 
  ...
  { 
    id: 404, name: "기자 피라미드", name_en: "Giza Pyramids", 
    country: "이집트", country_en: "Egypt",
    lat: 29.97, lng: 31.13, category: "culture", 
  ...
  { 
    id: 405, name: "앙코르 와트", name_en: "Angkor Wat", 
    country: "캄보디아", country_en: "Cambodia",
    lat: 13.41, lng: 103.86, category: "culture", 
  ...
  { 
    id: 406, name: "페트라", name_en: "Petra", 
    country: "요르단", country_en: "Jordan",
    lat: 30.32, lng: 35.44, category: "culture", 
  ...
  // ==========================================
  // 5. 🧗 Adventure (모험) - 대륙별 극한의 탐험지
  // ==========================================
  { 
    id: 501, name: "알래스카", name_en: "Alaska", 
    country: "미국", country_en: "USA",
    lat: 64.20, lng: -149.49, category: "adventure", 
  ...
  { 
    id: 502, name: "아마존 열대우림", name_en: "Amazon Rainforest", 
    country: "브라질", country_en: "Brazil",
    lat: -3.46, lng: -62.21, category: "adventure", 
  ...
  { 
    id: 503, name: "스발바르 제도", name_en: "Svalbard", 
    country: "노르웨이", country_en: "Norway",
    lat: 78.22, lng: 15.65, category: "adventure", 
  ...
  { 
    id: 504, name: "세렝게티", name_en: "Serengeti", 
  ...
  { 
    id: 506, name: "남극 대륙", name_en: "Antarctica", 
    country: "남극", country_en: "Antarctica",
    lat: -80.00, lng: 0.00, category: "adventure", 
