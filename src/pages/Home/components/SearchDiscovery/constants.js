...
/**
 * 탐색 첫 큐레이션 맨 앞 썸네일 — MRT 패키지 홈.
 * url은 호출부에서 buildMrtPkcHomeUrl로 채움(mylink 추적).
 */
export const MRT_EXPLORE_LEADING_PACKAGE = {
  id: 'mrt-explore-pkc-home',
  title: '패키지 여행',
  subtitle: '항공·호텔·투어를 한 번에',
  image:
    'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=560&h=746&fit=crop&q=80',
  imageAlt: '여행 비행 — 마이리얼트립 패키지',
  imageObjectPosition: 'center center',
  badge: '패키지 홈',
  affiliateSource: '마이리얼트립',
  url: '',
};

/** @deprecated {@link MRT_EXPLORE_LEADING_PACKAGE} */
export const TRIPCOM_EXPLORE_LEADING_CARD = MRT_EXPLORE_LEADING_PACKAGE;
