...
// ?ö® [Fix] ?òÍ?Í∏?Î≤ÑÌäº??z-50 Í∞ïÏ†ú Î∂Ä?¨Î°ú ÎßàÏö∞???∏Î≤Ñ Í∞ÄÎ°úÏ±î Î≤ÑÍ∑∏ ?¥Í≤∞
    ...
    <div className="min-h-screen bg-slate-800 flex items-center justify-center p-4 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-sm bg-white/95 backdrop-blur-xl border border-gray-200 p-6 rounded-3xl shadow-2xl relative z-10">
        ...
        <div className="text-center mb-5">
          ...
          <p className="text-xs text-gray-500 mt-1">?πÏã†???¨Ï†ï??Í∏∞Îã§Î¶¨Í≥† ?àÏäµ?àÎã§.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-3">
          ...
          >
            {loading ? <Loader2 size={16} className="animate-spin" /> : <>Î°úÍ∑∏??<ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" /></>}
          </button>
        </form>
