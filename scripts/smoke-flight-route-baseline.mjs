...
async function main() {
  ...
  const cases = [
    ...
    {
      id: 'no-preview-metro-gapyeong',
      label: 'no-preview — 가평(ICN↔GMP coterminal)',
      location: {
        ...uiPlaceLocation('가평', 37.8315, 127.5102),
        name_en: 'Gapyeong',
        country: '대한민국',
    ...
    {
      id: 'no-preview-metro-icheon',
      label: 'no-preview — 이천(ICN↔GMP coterminal)',
      location: {
        ...uiPlaceLocation('이천', 37.272, 127.435),
        name_en: 'Icheon',
        country: '대한민국',
        country_en: 'South Korea',
      },
    ...
    {
      id: 'no-preview-metro-pvg-sha',
      label: 'no-preview — 상하이 시내(PVG↔SHA coterminal)',
      location: {
        ...uiPlaceLocation('와이탄', 31.24, 121.5),
        name_en: 'The Bund',
        country: '중국',
        country_en: 'China',
      },
    ...
    {
      id: 'no-preview-kr-busan-mainland',
      label: 'no-preview — 부산 본토 국내선(ICN→PUS 숨김)',
      location: {
        ...uiPlaceLocation('부산', 35.1796, 129.0756),
        name_en: 'Busan',
        country: '대한민국',
        country_en: 'South Korea',
      },
    ...
    {
      id: 'no-preview-kr-yeonggeumjeong',
      label: 'no-preview — 영금정(ICN→YNY)',
      location: {
        ...uiPlaceLocation('영금정', 38.2118201, 128.6014768),
        name_en: 'Yeonggeumjeong',
        country: '대한민국',
        country_en: 'South Korea',
      },
      originIata: 'ICN',
    ...
    {
      id: 'no-preview-kr-junam',
      label: 'no-preview — 주남저수지(ICN→PUS)',
      location: {
        ...uiPlaceLocation('창원 주남저수지', 35.3182381, 128.675278),
        name_en: 'Junam Reservoir',
        country: '대한민국',
        country_en: 'South Korea',
      },
      originIata: 'ICN',
    ...
    {
      id: 'no-preview-kr-mindungsan',
      label: 'no-preview — 민둥산(ICN→WJU)',
      location: {
        ...uiPlaceLocation('민둥산', 37.2524, 128.7753),
        name_en: 'Mindungsan',
        country: '대한민국',
        country_en: 'South Korea',
      },
    ...
    },
    {
      ...
      location: {
        ...uiPlaceLocation('성산일출봉', 33.458, 126.942),
      ...
      originIata: 'ICN',
      expectPreview: true,
      expectRouteIatas: ['ICN', 'CJU'],
    },
    {
      id: 'preview-pvg-busan-intl',
      label: 'preview — 해외출발 부산(PVG→PUS 유지)',
      location: {
        ...uiPlaceLocation('부산', 35.1796, 129.0756),
        name_en: 'Busan',
        country: '대한민국',
