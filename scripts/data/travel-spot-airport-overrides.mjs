...
export const TRAVEL_SPOT_PLACE_ID_OVERRIDES = {
  ...
  나하: {
    ...
    preferredLinkIata: 'OKA',
    confidence: 'high',
    rationale: '나하공항(OKA) — placeIds-only(장소카드≠okinawa 편입)',
  },
  Naha: {
    primaryIatas: ['OKA'],
    preferredLinkIata: 'OKA',
    confidence: 'high',
    rationale: 'Naha OKA — placeIds-only',
  },
  아이투타키: {
    primaryIatas: ['AIT', 'RAR'],
    preferredLinkIata: 'AIT',
  ...
  일룰리사트: {
    ...
    kind: 'multi',
    confidence: 'high',
    rationale: '그린란드 일룰리사트 — iceland(KEF) 오매핑 금지 · placeIds-only(장소카드≠greenland)',
  },
  Ilulissat: {
    primaryIatas: ['CPH', 'GOH'],
    preferredLinkIata: 'CPH',
    kind: 'multi',
    confidence: 'high',
    rationale: '그린란드 일룰리사트 — iceland(KEF) 오매핑 금지 · placeIds-only',
  },
  일루리삿: {
    primaryIatas: ['CPH', 'GOH'],
    preferredLinkIata: 'CPH',
  ...
  파타야: {
    ...
    confidence: 'high',
    rationale: '파타야 — phuket(HKT) 편입 금지 · 관문 BKK placeIds-only',
  },
  Pattaya: {
    primaryIatas: ['BKK'],
    preferredLinkIata: 'BKK',
    confidence: 'high',
    rationale: 'Pattaya — BKK placeIds-only (≠phuket)',
  },
  '태국 파타야': {
    primaryIatas: ['BKK'],
    preferredLinkIata: 'BKK',
    confidence: 'high',
    rationale: '태국 파타야 — BKK placeIds-only (≠phuket)',
  },
  시엠립: {
    primaryIatas: ['SAI'],
    preferredLinkIata: 'SAI',
    confidence: 'high',
    rationale: '시엠립 도시 — angkor-wat 카드 편입 금지 · SAI placeIds-only',
  },
  'Siem Reap': {
    primaryIatas: ['SAI'],
    preferredLinkIata: 'SAI',
    confidence: 'high',
    rationale: 'Siem Reap city — SAI placeIds-only (≠angkor-wat card)',
  },
  앵커리지: {
    primaryIatas: ['ANC'],
    preferredLinkIata: 'ANC',
    confidence: 'high',
    rationale: '앵커리지 — alaska 카드 편입 금지 · ANC placeIds-only',
  },
  Anchorage: {
    primaryIatas: ['ANC'],
    preferredLinkIata: 'ANC',
    confidence: 'high',
    rationale: 'Anchorage — ANC placeIds-only (≠alaska)',
  },
  다윈섬: {
    primaryIatas: ['GPS', 'GYE'],
    preferredLinkIata: 'GPS',
    kind: 'multi',
    confidence: 'high',
    rationale: '갈라파고스 다윈섬 — galapagos 카드 편입 금지 · GPS/GYE placeIds-only',
  },
  'Darwin Island': {
    primaryIatas: ['GPS', 'GYE'],
    preferredLinkIata: 'GPS',
    kind: 'multi',
    confidence: 'high',
    rationale: 'Darwin Island — GPS/GYE placeIds-only (≠galapagos card)',
  },
};
