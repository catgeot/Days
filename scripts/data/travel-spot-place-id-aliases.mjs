...
export const TRAVEL_SPOT_PLACE_ID_ALIASES = {
  ...
  '바하마': 'bahamas',
  'Bahamas': 'bahamas',
  '스리자야와르데네푸라코테': 'sri-jayawardenapura',
  '베네수엘라': 'venezuela',
  'Venezuela': 'venezuela',
...
export const TRAVEL_SPOT_TOOLKIT_SYNONYMS = {
  ...
  nauru: ['나우루', 'Nauru', 'INU'],
  queenstown: ['퀸스타운', 'Queenstown', 'ZQN', '퀸즈타운'],
  minneapolis: ['미니애폴리스', 'Minneapolis', 'MSP'],
  perth: ['퍼스', 'Perth', 'PER'],
  bahamas: ['바하마', 'Bahamas', 'Nassau', 'NAS'],
  'sri-jayawardenapura': ['스리자aya와르데네푸라코테', 'Sri Jayawardenepura Kotte', 'Colombo', '콜롬보', 'CMB'],
  venezuela: ['베네수엘라', 'Venezuela', 'Caracas', 'CCS'],
