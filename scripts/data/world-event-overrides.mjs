...
export const WORLD_EVENT_OVERRIDES = [
      ...
      },
      {
        ...
        links: [
          ...
          },
          {
            ...
            labelEn: 'Venue map',
            kind: 'shop',
            href: 'https://www.edfringe.com/tickets',
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    source: 'curated',
    sourceUrl: 'https://en.wikipedia.org/wiki/Koningsdag',
    ...
    highlightContextLinks: [
      {
        ...
        links: [
          {
            id: 'kings-day-official',
            labelKo: '킹스데이 안내',
            labelEn: "King's Day guide",
            kind: 'shop',
            href: 'https://en.wikipedia.org/wiki/Koningsdag',
          },
        ],
      },
      {
  ...
  },
  {
    ...
    source: 'official_url',
    sourceUrl: 'https://www.japan.travel/en/spot/23/',
    ...
    highlightContextLinks: [
      {
        ...
        links: [
          {
            id: 'tokyo-sakura-official',
            labelKo: '도쿄 벚꽃 안내',
            labelEn: 'Tokyo cherry blossom guide',
            kind: 'shop',
            href: 'https://www.japan.travel/en/spot/23/',
          },
        ],
      },
      {
    ...
    highlightContextLinks: [
      {
        ...
        links: [
          {
            id: 'songkran-official',
            labelKo: '송크란 안내',
            labelEn: 'Songkran guide',
            kind: 'shop',
  ...
  },
  {
    ...
    source: 'curated',
    sourceUrl: 'https://en.wikipedia.org/wiki/Rio_Carnival',
        ...
        links: [
          {
            ...
            labelKo: '리우 카니발 안내',
            labelEn: 'Rio Carnival guide',
            kind: 'tour',
            href: 'https://en.wikipedia.org/wiki/Rio_Carnival',
          },
        ],
      },
      {
  ...
  },
  {
    ...
    source: 'curated',
    sourceUrl: 'https://www.macys.com/s/parade/',
        ...
        links: [
          {
            ...
            kind: 'tour',
            href: 'https://www.macys.com/s/parade/',
          },
        ],
      },
      {
  ...
  },
  {
    ...
    source: 'official_url',
    sourceUrl: 'https://festival.cz/en/',
    ...
    highlightContextLinks: [
      {
        ...
        links: [
          {
            id: 'rose-festival-official',
            labelKo: '로즈 페스티벌 안내',
            labelEn: 'Rose Festival guide',
            kind: 'shop',
            href: 'https://www.visitmorocco.com/en/travel/festivals',
          },
        ],
      },
      {
        ...
        links: [
          {
            ...
            labelEn: 'Official tickets',
            kind: 'shop',
            href: 'https://singaporegp.sg/en/tickets',
          },
        ],
      },
      {
        ...
        links: [
          {
            ...
            labelKo: 'Dubai Ride 안내',
            labelEn: 'Dubai Ride info',
            kind: 'shop',
            href: 'https://www.dubaifitnesschallenge.com/en/',
          },
        ],
      },
      {
        ...
        links: [
          {
            ...
            labelKo: 'Dubai Run 안내',
            labelEn: 'Dubai Run info',
            kind: 'shop',
            href: 'https://www.dubaifitnesschallenge.com/en/',
          },
        ],
        ...
        links: [
          {
            ...
            kind: 'shop',
            searchQueryKo: 'Centre Pompidou, Paris, France',
            searchQueryEn: 'Centre Pompidou, Paris, France',
            searchTarget: 'maps',
          },
        ],
      },
