...
export const TRAVEL_SPOT_COAST_OVERRIDES = {
  ...
  'new-caledonia': { coastKind: 'archipelago', seaPrimary: 'coral-sea', seaIds: ['coral-sea', 'tasman'] },
  tonga: { coastKind: 'archipelago', seaPrimary: 'south-pacific', seaIds: ['south-pacific', 'coral-sea'] },
  ...
  seychelles: { coastKind: 'archipelago', seaPrimary: 'mascarene-sea', seaIds: ['mascarene-sea', 'western-indian'] },
  mauritius: { coastKind: 'island', seaPrimary: 'mascarene-sea', seaIds: ['mascarene-sea', 'western-indian'] },
  'la-reunion': { coastKind: 'island', seaPrimary: 'mascarene-sea', seaIds: ['mascarene-sea', 'western-indian'] },
  zanzibar: { coastKind: 'island', seaPrimary: 'mozambique-channel', seaIds: ['mozambique-channel', 'western-indian'] },
  madagascar: { coastKind: 'island', seaPrimary: 'mozambique-channel', seaIds: ['mozambique-channel', 'western-indian'] },
  ...
  // --- 홍해 · 페르시아만 (니치 육로·리조트 게이트웨이) ---
  petra: { coastKind: 'coastal-city', seaPrimary: 'red-sea', seaIds: ['red-sea'] },
  'wadi-rum': { coastKind: 'peninsula', seaPrimary: 'red-sea', seaIds: ['red-sea'] },
  dubai: { coastKind: 'coastal-city', seaPrimary: 'persian-gulf', seaIds: ['persian-gulf', 'arabian'] },

  // --- 대서양 ---
  bermuda: { coastKind: 'island', seaPrimary: 'north-atlantic' },
  azores: { coastKind: 'archipelago', seaPrimary: 'macaronesia', seaIds: ['macaronesia', 'north-atlantic'] },
  madeira: { coastKind: 'island', seaPrimary: 'macaronesia', seaIds: ['macaronesia', 'north-atlantic'] },
  'canary-islands': { coastKind: 'archipelago', seaPrimary: 'macaronesia', seaIds: ['macaronesia', 'north-atlantic'] },
  'cape-verde': { coastKind: 'archipelago', seaPrimary: 'macaronesia', seaIds: ['macaronesia', 'north-atlantic'] },
