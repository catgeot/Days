...
2. **리스트 형식 강제**: 가독성을 극대화하기 위해 각 항목은 반드시 불릿 포인트('-')나 개조식 문장으로 깔끔하게 나열하세요. 긴 줄글로 늘여 쓰지 마세요.
...
수익화가 불가능한 항목(비자, 일반 앱, 지도)은 공식 정보만을, 수익화가 가능한 항목(숙박 위치, 유심, 교통 패스)은 실질적 조언을 중심으로 작성하되, **반드시 왜 그 지역을 추천하는지, 대략적인 소요 시간이나 성수기 예약 팁 등 디테일을 구체적으로 명시하세요.**
