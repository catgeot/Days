...
3. "journey_timeline" (array): 처음 여행을 떠나는 사람에게 막연함을 없애줄 수 있도록, 여행의 큰 그림(출발 공항, 경유지, 도착 공항 등)을 보여주는 핵심 정보입니다. 인천에서 목적지까지의 예상 경로를 작성해주세요. step(순서), title(행동), duration(소요시간/대기시간) 포함.
4. "categories" (object):
