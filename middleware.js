...
export const config = {
  matcher: ['/', '/korea', '/korea/theme/scenic', '/explore', '/explore/:continent/:category', '/blog', '/blog/curation', '/place/:slug', '/place/:slug/gallery', '/place/:slug/planner', '/place/:slug/wiki'],
};
