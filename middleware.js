...
export const config = {
  matcher: ['/', '/korea', '/korea/theme/scenic', '/explore', '/explore/:continent/:category', '/blog', '/blog/curation', '/world-events', '/place/:slug', '/place/:slug/gallery', '/place/:slug/planner', '/place/:slug/wiki'],
};
