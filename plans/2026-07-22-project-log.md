...
- **브랜치**: `cursor/city-attraction-batch16-73d0` = #15 tip(`9792fe0` · `batch15-7299`) **위 append**
...
- **참고**: 제시어 예(세비야·포르투·브뤼셀·고흥·장흥)는 **#15에 기등록** → 본 배치에서 중복 append 안 함. 경쟁 draft **#16**(`batch15-7bac` 북유럽 단독)은 #15 tip 미포함·함양/산청/코펜하겐 중복 → **닫기 권장**, 본 배치가 대체.
...
| 다음 | **본 배치(#16 stack)** | #15 tip 위 10 hub. 단독 머지 시 #14·#15 포함 |
| 닫기 | draft **#16** (`batch15-7bac`) | #15와 병렬 충돌 · 본 배치로 대체 |
...
- **다음 작업 (사용자 선택)**:
  1. **머지**: #14 → #15(`7299`) → 본 배치 · 경쟁 draft `batch15-7bac`·#4~#12 **닫기**(데스크톱)
  ...
  4. 릴리스 노트는 **합의 후**만
- **제시어**: `명소-이어하기` + `@plans/2026-07-22-project-log.md` · 「다음 8~12 hub 배치 (#16 tip 위 append)」 / 「#14→#15→본PR 머지부터」
