...
| 팔경 Tour contentId | `오케스트레이터` + `팔경contentId` + [`korea-local-scenic-contentid-queue.md`](./korea-local-scenic-contentid-queue.md) · 브랜치 **`cursor/palgyeong-cid`** · 「§5.7 · P0 잔여 **K01 short apply-unique** · 본명 keyword 로또 금지 · 워커 병렬 LIVE 금지 · 429 정지 · UI 금지 · AI가 ID 기입 금지 · §3.6」 |
