...
**상태**: feature `cursor/scenic-empty-chips-1837` · 칩·문구 [#70](https://github.com/catgeot/Days/pull/70) main 반영 · 제목 아이콘 후속 PR 대기
...
- **작업 로그**: 「분류칩 숨김」·「문구 정리」·「제목 아이콘」
- **QA(사람)**: 양양 hub → GATEO 칩·「골랐습니다」 없음 · 세 제목 아이콘 구분 · 국가유산·관광지 정상
