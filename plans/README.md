...
- **국내 MRT 읍·면+county 공백 감사 Phase 0 ✅**: [`mrt-stay-admin-gap-audit-plan.md`](./mrt-stay-admin-gap-audit-plan.md) §5.1 · `npm run audit:mrt-stay-admin-gaps` · RISK **0** · 잔여 city=리 keyword
