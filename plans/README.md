...
- **항공 경로 DB (우선)**: [`flight-route-database-plan.md`](./flight-route-database-plan.md) · **비-ICN 라우팅**: [`flight-route-non-icn-routing-plan.md`](./flight-route-non-icn-routing-plan.md) (OurAirports·Supabase · **Phase 0~4 v2.2 ✅** · **비-ICN waypoint·경유 ⏳**)
...
- **일별 작업 로그**: `YYYY-MM-DD-project-log.md`  
  - 최신: [`2026-06-29-project-log.md`](./2026-06-29-project-log.md)  
