...
- **한국의 테마여행 `/korea/theme` (S0–S8·S10 ✅ · #13 코스 사진 보강 · S9 폴리시 대기)**: [`korea-theme-travel-plan.md`](./korea-theme-travel-plan.md) · 일지 `2026-08-04` · 여행코스 사진·명승 34 · 구현 브랜치 `cursor/korea-theme` · PR [#58](https://github.com/catgeot/Days/pull/58)
