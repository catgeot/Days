...
- **국내 축제·지역 허브 `/korea` (머지 QA tip `bb7ee5e` · `merge/korea-festival-into-main` · main 미병합)** : [`korea-festival-hub-plan.md`](./korea-festival-hub-plan.md) · 일지 `2026-07-28`
...
- **일별 작업 로그**: `YYYY-MM-DD-project-log.md`  
  - 최신: [`2026-07-28-project-log.md`](./2026-07-28-project-log.md) · 직전 [`2026-07-27-project-log.md`](./2026-07-27-project-log.md)  
