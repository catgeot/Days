...
- **동명 리/읍/면/동 검색 다후보 ✅**: [`ko-homonym-ri-search-disambiguation-plan.md`](./ko-homonym-ri-search-disambiguation-plan.md) · [`ko-homonym-search-expand-plan.md`](./ko-homonym-search-expand-plan.md) (`동` O · bare 보류) · `smoke:ko-homonym-ri-search`
- **동명 bare 화이트리스트 (다음)**: 계획 §4 · 제시어 `동명검색-bare-화이트리스트-이어하기` · `audit:ko-homonym-expand`
