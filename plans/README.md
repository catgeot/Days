...
- **항공 경로 DB (우선)**: [`flight-route-database-plan.md`](./flight-route-database-plan.md) (OurAirports·Supabase · **Phase 0~3 ✅** · graph avoid-zone **✅** · **Phase 4 다음** · 제시어 `항공경로-DB-Phase4-실행`)
