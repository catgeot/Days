...
- **한국의 테마여행 `/korea/theme` (#20 본문 가독성 · **다음 #21 폴리시·릴리스**)**: [`korea-theme-travel-plan.md`](./korea-theme-travel-plan.md) · 일지 `2026-08-05` · 구현 브랜치 `cursor/korea-theme` · PR [#58](https://github.com/catgeot/Days/pull/58)
