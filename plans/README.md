...
- **방문자 활성화 및 사이트 체질 개선 종합 계획 (P0~P2 4단계 8세션 로드맵)**: [`visitor-growth-activation-plan.md`](./visitor-growth-activation-plan.md) · 그록봇 12대 개선점 실사 및 세션별 실행 가이드
...
- **일별 작업 로그**: `YYYY-MM-DD-project-log.md`  
  - 최신: [`2026-09-13-project-log.md`](./2026-09-13-project-log.md) · 직전 [`2026-09-12-project-log.md`](./2026-09-12-project-log.md)  
