...
| 파일 | 용도 |
|------|------|
| [`src/pages/Home/data/travelSpots.js`](../src/pages/Home/data/travelSpots.js) | **SSOT** — slug, 좌표, tier, SEO·글로브·사이트맵 (투어 카메라 center와 **분리** — [`globeLandmarks.json`](../src/pages/Home/data/globeLandmarks.json), [`2026-06-02-globe-enrichment-plan.md`](./2026-06-02-globe-enrichment-plan.md)) |
