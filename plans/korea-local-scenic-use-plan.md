...
| **지금** | #1 push `e8da2987` · PR [#186](https://github.com/catgeot/Days/pull/186) · **#2 Preview QA** | P2-L5 ✅ 3 HIT · P2 null **87** · tip `90c2966d` · **다음 P2-L6** |
...
| — | `팔경contentId #P2-L6, hub-batch keyword` | B | **다음** |
