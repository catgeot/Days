...
| **지금** | **#53 push** tip `4b9c7468` · PR [#268](https://github.com/catgeot/Days/pull/268) · 여수10경 3 + 탐색홈 진남관·이순신대교 빈 썸네일 · **#54 예천 결손 오버레이** | **main 병합 완료 ✅** · squash merge `53b21b00` · PR [#185](https://github.com/catgeot/Days/pull/185) |
...
| 53 | `팔경 활용 #53, 여수 결손 오버레이` | A | **완료** · tip `4b9c7468` · PR [#268](https://github.com/catgeot/Days/pull/268) · 여수10경 3 · QA 탐색홈 진남관·이순신대교 빈 썸네일 |
