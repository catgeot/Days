...
| **지금** | #1 push `e8da2987` · PR [#186](https://github.com/catgeot/Days/pull/186) · **#2 Preview QA** | P0-P02 ✅ 옥정호 ambiguous 1/1 · members **578/876** · tip `3392e61e` · **다음 P0-P03** 칠선시류 ambiguous (1) |
...
| — | `팔경contentId #P0-P03, 칠선시류 ambiguous` | B | **다음** |
