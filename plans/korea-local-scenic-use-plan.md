...
| **지금** | **#48 QA push** tip `9a95d38a` · PR [#258](https://github.com/catgeot/Days/pull/258) · 동해비경 3 · QA 용추·반석 분리·망상·어달 썸네일 · **#49 영광 결손 오버레이** | **main 병합 완료 ✅** · squash merge `53b21b00` · PR [#185](https://github.com/catgeot/Days/pull/185) |
...
| 48 | `팔경 활용 #48, 동해 결손 오버레이` | A | **완료** · tip `9a95d38a` · PR [#258](https://github.com/catgeot/Days/pull/258) · 동해비경 3 · QA 용추·반석 분리·망상 125713·어달 125708 |
