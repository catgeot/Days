...
| **지금** | #10 merge `d28b4733` · PR [#213](https://github.com/catgeot/Days/pull/213) · **다음 #12 광양·하동 결손 오버레이** | **main 병합 완료 ✅** · squash merge `53b21b00` · PR [#185](https://github.com/catgeot/Days/pull/185) |
...
| 11 | `팔경 활용 #11, 사람 Preview QA` | A 사람 | **완료** · #213 merge 후 결손 오버레이로 전환 |
| 12 | `팔경 활용 #12, 광양·하동 결손 오버레이` | A | **열기 가능** · 광양9경 6건 · 하동10경 7건 사진·개요 |
