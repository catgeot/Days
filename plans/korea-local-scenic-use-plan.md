...
| **지금** | **#18 push** `900d77af` · **#19 사람 Preview QA** (한천 행 부제 한천 N경) | **main 병합 완료 ✅** · squash merge `53b21b00` · PR [#185](https://github.com/catgeot/Days/pull/185) |
...
| 18 | `팔경 활용 #18, 한천 행 부제 공식명` | A | **완료** · tip `900d77af` · 한천 1경·양산 1경 |
| 19 | `팔경 활용 #19, 사람 Preview QA` | A 사람 | **열기 가능** · 한천 그룹·행 부제 일치 · 그다음 함안9경 7 |
