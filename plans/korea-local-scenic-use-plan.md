...
| **지금** | #1 push `e8da2987` · PR [#186](https://github.com/catgeot/Days/pull/186) · **#2 Preview QA** | P0-K09 ⬜ short `--limit=40` · members **528/876** · tip `0c14512e` |
...
| — | `팔경contentId #P0-K09, short 종결` | B | **다음** |
| — | `팔경contentId #P0-K08, prefix 종결` | B | **완료** · tip `0c14512e` 4/40 |
