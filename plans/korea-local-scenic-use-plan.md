...
| **지금** | #1 push `e8da2987` · PR [#186](https://github.com/catgeot/Days/pull/186) · **#2 Preview QA** | P0-C01 ✅ scenic 복사 소진 · members **548/876** · tip `e78f0e5a` · **다음 P0-A03** siho |
...
| — | `팔경contentId #P0-A03, siho alias` | B | **다음** |
