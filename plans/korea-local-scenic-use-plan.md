...
| **지금** | #1 push `e8da2987` · PR [#186](https://github.com/catgeot/Days/pull/186) · **#2 Preview QA** | R01–R16 ✅ · **P0 소진** · P1-R01–R09 ✅ · cid 292/876 · hub+P1 61 · 다음 P1-R10 |
...
| — | `오케스트레이터 팔경contentId` | B | P0 ✅ · P1-R01–R09 ✅ · P1-R10 ⬜ |
| — | `지자체 팔경 #…` | 수집 종료 | **열지 않음** |
