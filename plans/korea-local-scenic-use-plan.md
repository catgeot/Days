...
| **지금** | #1 push `e8da2987` · PR [#186](https://github.com/catgeot/Days/pull/186) · **#2 Preview QA** | P0-C01·S01 ✅ · **다음 P0-L07** keyword LIVE · members **459/876** · tip `55cfd8ab` |
...
| — | `팔경contentId #P0-L07, 확장 keyword` | B | **다음** · 이어서 A01 |
