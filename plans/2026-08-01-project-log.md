...
## Cloud 작업 규칙 #1, main 반영

- **세션**: `Cloud 작업 규칙 #1, main 반영`
- **브랜치(짧음)**: `cursor/cloud-rules-8320` ← 구 `cursor/cloud-preview-continuity-8320` 이전
- **공유 (테스터)**: https://www.gateo.kr/qa/puzzle · 목록 https://www.gateo.kr/qa
