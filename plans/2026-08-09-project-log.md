...
**상태**: feature `cursor/scenic-yangyang-b772` · PR [#75](https://github.com/catgeot/Days/pull/75) · tip `721a49e9` · Preview 사람 QA 대기
...
- **남은 일**: 큐 경상 잔여(고성·구미·함안·밀양·사천…) 전수 · 사람 Preview QA
- **다음 채팅명**:
