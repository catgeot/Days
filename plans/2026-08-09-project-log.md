...
**상태**: feature `cursor/scenic-yangyang-b772` · PR [#75](https://github.com/catgeot/Days/pull/75) · tip `030fd568` · Preview 사람 QA 대기
...
- **남은 일**: 큐 경상 잔여(청송·칠곡·독도·김천·고령…) 전수 · 사람 Preview QA
- **다음 채팅명**:
