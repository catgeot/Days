...
**상태**: feature `cursor/scenic-yangyang-b772` · PR [#75](https://github.com/catgeot/Days/pull/75) · tip `1ef6b753` · Preview 사람 QA 대기
...
- **남은 일**: 큐 R01 전라 잔여(나주·신안…) 전수 · 사람 Preview QA
- **다음 채팅명**:
