...
## 로컬 머지 — main + cursor/korea-festival-proxy

**상태**: ✅ 충돌 해소 · 검증 PASS · **로컬만** (`merge/korea-festival-into-main`) · **미push** · 사람 `/korea`·홈 QA 후 반영

| 항목 | |
|------|--|
| base | `main` `d01cf52` |
| 축제 tip | `389b7f7` (S5 C) |
| 충돌 | `.ai-context` · `AGENTS` · `gateo-project-context` · `package.json` · `plans/README` · `2026-07-26` 일지 |
| 자동 | `HomeUI`(국내 링크+메인 테마칩 유지) · `App` · `vite` · sitemap · Edge tourapi |
...
브랜치 merge/korea-festival-into-main (UX tip 2c7836d).
