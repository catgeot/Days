...
| **카테고리 버튼** | 마커 숨김/강조 **없음** — **5면 큐레이션 중심 pan** · **확대 중 줌·고도**: **모바일** 초기값 복귀 · **데스크톱(≥1024px)** flyTo 줌·고도(2.35 / legacy 2.1) · 홈 진입·복귀 **랜덤 면** · 대양·공해는 드래그 탐험 |
...
- **이동**: `resolveCategoryFaceMapboxZoom` / `resolveCategoryFaceLegacyAltitude` — **모바일** 초기 줌·고도 · **데스크톱** flyTo 줌·고도 · pitch·bearing 유지
