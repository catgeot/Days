...
- **사람 Preview QA 피드백 & 최종 확정 (2026-09-14)**:
  - 상단 공간을 점유하는 카드형 히어로 및 모바일 우측 중복 아이콘(로그인/AI) 전면 제거 → **배포본 미니멀 UI 100% 복원**.
  - **대안 A(검색바 문구)** + **대안 B(무니 인트로 넛지)** 복합 적용으로 상단 공간 점유 0px 유지하면서 사이트 정체성 및 탐색 행동 유도 완결.
...
**#5** (`f3c5ddbf` · PR [#253](https://github.com/catgeot/Days/pull/253)) — 스켈레톤·에러 UX + 로그인 후 비밀번호 변경 경로. 세션 #6(신뢰·제휴) 제시어:
