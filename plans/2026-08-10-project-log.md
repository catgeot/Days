...
**상태**: feature `cursor/scenic-map-a086` · PR [#85](https://github.com/catgeot/Days/pull/85) · tip `5d20bdb4` · Preview QA 대기
...
- **작업 로그**: 「명소 지도 대→중→소 드릴다운」
- **남은 일**: 사람 Preview QA · (선택) 명승·관광지 지도에도 동일 드릴다운 · 내 주변 GPS 지도 연동
- **다음 채팅명**:
