...
| 4 | L2 `L2_PREP` 4칩(비자·입국·서류 묶음 등) · L2 dock L1 라벨 |
| 5 | `placePlannerFocus` — `#planner-prep-visa` · `#planner-prep-safety` · `PlannerTab` 스크롤 |
...
| [`placePlannerFocus.js`](../src/utils/placePlannerFocus.js) | hash·발화→포커스·스크롤 |
...
| [`placePlannerFocus.js`](src/utils/placePlannerFocus.js) | 플래너 hash 포커스 (§2.13) |
