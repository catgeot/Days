...
**상태**: R01–R09 ✅ · 다음 ⬜ **R10** · membersWithContentId **150**/876 · LIVE 쿼터 주의  
...
| **R10** | `mokpo-gugyeong` · `muan-gugyeong` · `jindo-other` | `haenam-palgyeong` · `wando-palgyeong` · `gangjin-other` | DB-only | ⬜ |
