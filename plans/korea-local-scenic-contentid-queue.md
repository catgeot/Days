...
**상태**: R01–R16 ✅ · **P0·P1 F 소진** · membersWithContentId **482**/876 · hub+P1 **68** · P2 **null 104**/871(78 hub) · **P2-L2** ✅ 0/104 · **P0-L** ✅ 109/584 · **P0-L02·L03·L05** ✅ 0/100(동일 본명 keyword **폐기**) · **P0-L06 폐기** · **P0-L07++** ✅ 2/100 · **P0-L07+++ 폐기**(같은 100명 로또) · **다음 P0-K01** 키워드 종결 · Tour API **운영 승인 ~10만/일**  
...
**인벤토리** (2026-09-08, null **394**): siho **48** · poetic **23** · prefix **142** · short **140** · other **41** · closed **0**
...
| R | 방식 | 한도 | 모드 | 상태 |
|---|------|------|------|------|
| **P0-K01** | `--bucket=short --apply-unique --limit=40` | 쿼터 ~10만/일 | LIVE | ⬜ 다음 |
| **P0-K02** | `--bucket=prefix --apply-unique --limit=40` | 쿼터 ~10만/일 | LIVE | ⬜ |
| **P0-K03** | `--bucket=poetic --apply-unique` | 쿼터 ~10만/일 | LIVE | ⬜ |
...
**채팅명** `팔경contentId #P0-K01, 키워드 종결`

| | |
|--|--|
| **브랜치** | `cursor/palgyeong-cid` · tip `2265f248` · PR [#185](https://github.com/catgeot/Days/pull/185) |
| **스냅샷** | P0 멤버 **482/876** (null **394**) · open short **140** · close JSON inventory ✅ |
