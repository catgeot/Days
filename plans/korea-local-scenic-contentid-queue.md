...
**상태**: R01–R16 ✅ · **P0·P1 F 소진** · membersWithContentId **400**/876 · hub+P1 **68** · P2 **null 104**/871(78 hub) · **P2-L2** ✅ 0/104 · **P0-L** ✅ 109/584 · **P0-L02** ✅ 0/100 · Tour API **운영 승인 ~10만/일** · 다음 **P0-L03+ keyword**  
...
| **P0-L03+** | 동일 `--keyword-only --limit=100` (잔여 null **476**) | 쿼터 ~10만/일 | LIVE | ⬜ **다음 세션** |
...
| **스냅샷** | P0 멤버 **400/876** (null **476**) · P2 테마 null **104**/871 · P0-L02 **0/100** · resume **584**건(476 null 전부 포함) · 429 없음 |
