...
**상태**: R01–R16 ✅ · **P0·P1 F 소진** · membersWithContentId **567**/876 · hub+P1 **68** · P2 **null 104**/871(78 hub) · **P2-L2** ✅ 0/104 · **P0-L** ✅ 109/584 · **P0-L02·L03·L05** ✅ 0/100(동일 본명 keyword **폐기**) · **P0-L06 폐기** · **P0-L07++** ✅ 2/100 · **P0-L07+++ 폐기**(같은 100명 로또) · **P0-K01** ✅ 10/40 · **P0-K02** ✅ 4/40 · **P0-K03** ✅ 4/23 · **P0-K04** ✅ 5/41 · **P0-K05** ✅ 8/40 · **P0-K06** ✅ 3/40 · **P0-K07** ✅ 8/40 · **P0-K08** ✅ 4/40 · **P0-K09** ✅ 8/21 · **P0-K10** ✅ 5/22 · **P0-K11** ✅ 0/2 · **P0-K12** ✅ 0/1 · **P0-A02** ✅ 6/48 · **P0-C01** ✅ 소진 · **P0-A03** ✅ 11/41 · **P0-A04** ✅ 8/29 · **다음 P0-A05** siho alias (21) · Tour API **운영 승인 ~10만/일**  
...
**인벤토리** (2026-09-09 P0-A04 후, null **309**): siho **0 open**(siho_wait **21**·hub_mismatch **2**) · poetic **0** · prefix **0 open**(ambiguous **2**) · short **0**(ambiguous **1**) · other **0** · closed **369**
...
**채팅명** `팔경contentId #P0-A05, siho alias`

| | |
|--|--|
| **브랜치** | `cursor/palgyeong-cid` · tip `2b7dc375` · PR [#185](https://github.com/catgeot/Days/pull/185) |
| **스냅샷** | P0 멤버 **567/876** (null **309**) · siho_wait **21** · hub_mismatch **2** · prefix ambiguous **2** · closed **369** |
