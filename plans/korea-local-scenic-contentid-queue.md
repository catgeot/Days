...
**상태**: R01–R16 ✅ · **P0 F 소진** · P1-R01–R04 ✅ · membersWithContentId **292**/876 · hub+P1 **33** · 다음 **P1-R05** · LIVE 쿼터 주의  
...
| 순위 | 대상 | 상태 |
|------|------|------|
| P1 | hub `attractions[]` 중 `contentId` 없는 KR 명소 | **P1-R01–R04** ✅ 33/146 · **P1-R05** ⬜ |
...
| **P1-R05** | `sacheon` · `uiryeong` · `geoje` | `ganghwa` · `geochang` · `haman` | DB-only | ⬜ |
