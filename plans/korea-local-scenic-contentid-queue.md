...
**상태**: R01–R16 ✅ · **P0·P1 F 소진** · membersWithContentId **541**/876 · hub+P1 **68** · P2 **null 104**/871(78 hub) · **P2-L2** ✅ 0/104 · **P0-L** ✅ 109/584 · **P0-L02·L03·L05** ✅ 0/100(동일 본명 keyword **폐기**) · **P0-L06 폐기** · **P0-L07++** ✅ 2/100 · **P0-L07+++ 폐기**(같은 100명 로또) · **P0-K01** ✅ 10/40 · **P0-K02** ✅ 4/40 · **P0-K03** ✅ 4/23 · **P0-K04** ✅ 5/41 · **P0-K05** ✅ 8/40 · **P0-K06** ✅ 3/40 · **P0-K07** ✅ 8/40 · **P0-K08** ✅ 4/40 · **P0-K09** ✅ 8/21 · **P0-K10** ✅ 5/22 · **P0-K11** ✅ 0/2 · **다음 P0-K12** short `--limit=40` · Tour API **운영 승인 ~10만/일**  
...
**인벤토리** (2026-09-09 P0-K11 후, null **335**): siho **48** · poetic **0** · prefix **0 open**(ambiguous **2**) · short **1** · other **0** · closed **343**
...
| **P0-K12** | `--bucket=short --apply-unique --limit=40` (임실 옥정호 1건) | 쿼터 ~10만/일 | LIVE | ⬜ 다음 |
...
**채팅명** `팔경contentId #P0-K12, short 종결`

| | |
|--|--|
| **브랜치** | `cursor/palgyeong-cid` · tip `c12f063a` · PR [#185](https://github.com/catgeot/Days/pull/185) |
| **스냅샷** | P0 멤버 **541/876** (null **335**) · prefix **소진**(ambiguous **2**) · short open **1**(임실 옥정호) · siho **48** · other **0** · closed **343** |
| **1순위** | `close:korea-local-scenic-content-ids --bucket=short --apply-unique --limit=40` · HIT는 LIVE 행만 |
| **읽기** | index 팔경 contentId 행 · 본 큐 「P0 키워드 종결 (K)」· method **§5.7** |
| **금지** | UI · scenic 승격 · AI가 contentId 숫자 기입 · `--keyword-only --limit=100` 로또 · feature에 `plans/**` · apply 후 `inventory` 재실행(ambiguous→open 덮어씀) |
