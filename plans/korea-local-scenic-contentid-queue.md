...
**인벤토리** (2026-09-09 P0-K12 후, null **335**): siho **48** · poetic **0** · prefix **0 open**(ambiguous **2**) · short **0**(ambiguous **1**) · other **0** · closed **344**
...
| **P0-A02** | `--bucket=siho` · 공식 본명 alias → LIVE (gunsan 등) | 소수 | 혼합 | ⬜ 다음 |
...
**채팅명** `팔경contentId #P0-A02, siho alias`

| | |
|--|--|
| **브랜치** | `cursor/palgyeong-cid` · tip `a5131b5a` · PR [#185](https://github.com/catgeot/Days/pull/185) |
| **스냅샷** | P0 멤버 **541/876** (null **335**) · short **소진** · prefix **소진**(ambiguous **2**) · siho **48** · other **0** · closed **344** |
| **1순위** | `close:korea-local-scenic-content-ids --bucket=siho --apply-unique` · alias→LIVE · HIT는 LIVE 행만 |
