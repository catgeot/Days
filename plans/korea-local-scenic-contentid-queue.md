...
**상태**: R01–R16 ✅ · **P0·P1 F 소진** · membersWithContentId **524**/876 · hub+P1 **68** · P2 **null 104**/871(78 hub) · **P2-L2** ✅ 0/104 · **P0-L** ✅ 109/584 · **P0-L02·L03·L05** ✅ 0/100(동일 본명 keyword **폐기**) · **P0-L06 폐기** · **P0-L07++** ✅ 2/100 · **P0-L07+++ 폐기**(같은 100명 로또) · **P0-K01** ✅ 10/40 · **P0-K02** ✅ 4/40 · **P0-K03** ✅ 4/23 · **P0-K04** ✅ 5/41 · **P0-K05** ✅ 8/40 · **P0-K06** ✅ 3/40 · **P0-K07** ✅ 8/40 · **다음 P0-K08** prefix `--limit=40` · Tour API **운영 승인 ~10만/일**  
...
**인벤토리** (2026-09-08 P0-K07 후, null **352**): siho **48** · poetic **0** · prefix **62** · short **21** · other **0** · closed **263**
...
| **P0-K08** | `--bucket=prefix --apply-unique --limit=40` | 쿼터 ~10만/일 | LIVE | ⬜ 다음 |
...
**채팅명** `팔경contentId #P0-K08, prefix 종결`

| | |
|--|--|
| **브랜치** | `cursor/palgyeong-cid` · tip `c3360044` · PR [#185](https://github.com/catgeot/Days/pull/185) |
| **스냅샷** | P0 멤버 **524/876** (null **352**) · open short **21** · prefix **62** · siho **48** · other **0** · closed **263** |
