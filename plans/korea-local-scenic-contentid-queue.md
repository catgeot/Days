...
| **P2-L9** | hub-batch `--hubs=gwangyang,sancheong,yeongyang,pohang,mokpo,ulleung,gapyeong,gongju,jecheon,yanggu` `--keyword-only --limit=20` | 쿼터 ~10만/일 | LIVE | ⬜ **다음** |
...
**인벤토리** (2026-09-09 P0-P03 후, null **297**): siho **0** · poetic **0** · prefix **0** · short **0** · other **0** · closed **394** · ambiguous open **0**
...
| **P0-A07** | `--bucket=siho --apply-unique` · KEYWORD_ALIASES 2건 → LIVE | 소수 | 혼합 | ✅ 2026-09-09 **2/8** · members **577/876** · tip `0287f117` |
| **P0-P01** | prefix ambiguous 2건 — close JSON titles·주소 확인 → unique면 lists | — | 수동 | ✅ 2026-09-09 **2/2** · members **579/876** · tip `fb936d9c` |
...
**채팅명** `팔경contentId #P2-L9, hub-batch keyword`

| | |
|--|--|
| **브랜치** | `cursor/palgyeong-cid` · tip `699ac841` · PR [#185](https://github.com/catgeot/Days/pull/185) |
| **스냅샷** | P0 **종료** members **579/876** null **297**(terminal) · P2 scenic null **81**/871 · P2-L8 **0/20** 실행 · 다음 P2-L9 잔여 10건(광양~양구) |
| **1순위** | `fill:korea-scenic-spot-content-ids --hubs=gwangyang,sancheong,yeongyang,pohang,mokpo,ulleung,gapyeong,gongju,jecheon,yanggu --keyword-only --limit=20` → generate · audit/smoke scenic |
| **읽기** | index 팔경 contentId 행 · 본 큐 「P2 LIVE」· method **§5.7** |
| **금지** | UI · scenic 승격 · 워커 병렬 LIVE · L3/L4/L5/L6/L7/L8 hub 본명 재시도 · AI가 contentId 기입 · feature에 `plans/**` |
