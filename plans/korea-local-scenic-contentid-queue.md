...
**상태**: R01–R16 ✅ · **P0·P1 F 소진** · membersWithContentId **500**/876 · hub+P1 **68** · P2 **null 104**/871(78 hub) · **P2-L2** ✅ 0/104 · **P0-L** ✅ 109/584 · **P0-L02·L03·L05** ✅ 0/100(동일 본명 keyword **폐기**) · **P0-L06 폐기** · **P0-L07++** ✅ 2/100 · **P0-L07+++ 폐기**(같은 100명 로또) · **P0-K01** ✅ 10/40 · **P0-K02** ✅ 4/40 · **P0-K03** ✅ 4/23 · **다음 P0-K04** other 종결 · Tour API **운영 승인 ~10만/일**  
...
**인벤토리** (2026-09-08 P0-K03 후, null **376**): siho **48** · poetic **0** · prefix **102** · short **100** · other **41** · closed **103**
...
| **P0-K04** | `--bucket=other --apply-unique` | 쿼터 ~10만/일 | LIVE | ⬜ 다음 |
...
**채팅명** `팔경contentId #P0-K04, other 종결`

| | |
|--|--|
| **브랜치** | `cursor/palgyeong-cid` · tip `4dcee055` · PR [#185](https://github.com/catgeot/Days/pull/185) |
| **스냅샷** | P0 멤버 **500/876** (null **376**) · open other **41** · closed **103** |
| **1순위** | `close:korea-local-scenic-content-ids --bucket=other --apply-unique` · HIT는 LIVE 행만 |
