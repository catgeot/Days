...
**인벤토리** (2026-09-09 P0-K10 후, null **335**): siho **48** · poetic **0** · prefix **2** · short **1** · other **0** · closed **343**
...
| **P0-K11** | `--bucket=prefix --apply-unique --limit=40` (잔여 2) | 쿼터 ~10만/일 | LIVE | ⬜ 다음 |
...
**채팅명** `팔경contentId #P0-K11, prefix 잔여`

| | |
|--|--|
| **브랜치** | `cursor/palgyeong-cid` · tip `1388e038` · PR [#185](https://github.com/catgeot/Days/pull/185) |
| **스냅샷** | P0 멤버 **541/876** (null **335**) · open prefix **2** · short **1**(ambiguous) · siho **48** · other **0** · closed **343** |
