...
| | |
|--|--|
| **상태** | **#45** tip `47f2ac91` · PR [#252](https://github.com/catgeot/Days/pull/252) · 홍성12경 4 · **#46 화순 결손 오버레이** |
| **브랜치** | `cursor/palgyeong-use-e744` |
| **tip** | `47f2ac91` |
| **PR** | [#252](https://github.com/catgeot/Days/pull/252) · [#251](https://github.com/catgeot/Days/pull/251) merge ✅ · [#250](https://github.com/catgeot/Days/pull/250) merge ✅ |
| **플랜** | [`korea-local-scenic-use-plan.md`](./korea-local-scenic-use-plan.md) **§9 A** |
| **일지** | [`2026-09-14-project-log.md`](./2026-09-14-project-log.md) |
| **Preview** | `/qa/palgyeong-use` → git Preview `/korea/theme/scenic?hub=hongseong` |
