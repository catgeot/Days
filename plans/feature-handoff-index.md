...
| | |
|--|--|
| **상태** | **#64 QA push** tip `83dc35a4` · PR [#284](https://github.com/catgeot/Days/pull/284) · 무안 검색 승달산·초의 썸네일 · **#65 보성 결손 오버레이** |
| **브랜치** | `cursor/palgyeong-use-e744` |
| **tip** | `83dc35a4` |
| **PR** | [#284](https://github.com/catgeot/Days/pull/284) · [#282](https://github.com/catgeot/Days/pull/282) merge ✅ · [#280](https://github.com/catgeot/Days/pull/280) merge ✅ · [#279](https://github.com/catgeot/Days/pull/279) merge ✅ |
| **플랜** | [`korea-local-scenic-use-plan.md`](./korea-local-scenic-use-plan.md) **§9 A** |
| **일지** | [`2026-09-19-project-log.md`](./2026-09-19-project-log.md) |
| **Preview** | `/qa/palgyeong-use` → git Preview `/korea/theme/scenic?hub=muan` · 「무안」검색 8경 승달산·4경 초의선사탄생지 썸네일 |
