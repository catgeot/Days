...
| | |
|--|--|
| **상태** | **#60 QA push** tip `3f6ce41b` · PR [#278](https://github.com/catgeot/Days/pull/278) · 의정부8경 3 · **#61 통영 결손 오버레이** |
| **브랜치** | `cursor/palgyeong-use-e744` |
| **tip** | `3f6ce41b` |
| **PR** | [#278](https://github.com/catgeot/Days/pull/278) · [#277](https://github.com/catgeot/Days/pull/277) merge ✅ · [#275](https://github.com/catgeot/Days/pull/275) merge ✅ |
| **플랜** | [`korea-local-scenic-use-plan.md`](./korea-local-scenic-use-plan.md) **§9 A** |
| **일지** | [`2026-09-18-project-log.md`](./2026-09-18-project-log.md) |
| **Preview** | `/qa/palgyeong-use` → git Preview `/korea/theme/scenic?hub=uijeongbu` 의정부8경 수락산 도정봉·의정부경전철·의정부제일시장 |
