...
| | |
|--|--|
| **상태** | **#59 QA push** tip `a0f0d93b` · PR [#277](https://github.com/catgeot/Days/pull/277) · 태백8경 3 · **#60 의정부 결손 오버레이** |
| **브랜치** | `cursor/palgyeong-use-e744` |
| **tip** | `a0f0d93b` |
| **PR** | [#277](https://github.com/catgeot/Days/pull/277) · [#275](https://github.com/catgeot/Days/pull/275) merge ✅ · [#274](https://github.com/catgeot/Days/pull/274) merge ✅ |
| **플랜** | [`korea-local-scenic-use-plan.md`](./korea-local-scenic-use-plan.md) **§9 A** |
| **일지** | [`2026-09-18-project-log.md`](./2026-09-18-project-log.md) |
| **Preview** | `/qa/palgyeong-use` → git Preview `/korea/theme/scenic?hub=taebaek` 태백8경 장성하부고생대화석산지·용연굴·절골마을관리휴양지 |
