...
| | |
|--|--|
| **상태** | **#62 push** tip `52b5126e` · PR [#280](https://github.com/catgeot/Days/pull/280) · 광주8경 무갑산 5경 공식 사진·홈 · 송정사 건너뜀 · **#63 목포 결손 오버레이** |
...
| **일지** | [`2026-09-18-project-log.md`](./2026-09-18-project-log.md) |
| **Preview** | `/qa/palgyeong-use` → git Preview `/korea/theme/scenic?hub=gwangju_gi` 광주8경 5경 무갑산 · 송정사 빈 썸네일 유지 |
