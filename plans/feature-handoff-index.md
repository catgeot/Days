...
| | |
|--|--|
| **상태** | R01–R16 ✅ · **P0·P1 F 소진** · members **541/876** · P2 **null 104** · **P0-K11** ✅ prefix 소진 · **다음 P0-K12** short 1건 · A와 **동시 OK** |
| **브랜치** | `cursor/palgyeong-cid` · tip `c12f063a` |
...
| **큐** | [`korea-local-scenic-contentid-queue.md`](./korea-local-scenic-contentid-queue.md) — **P0-K12** short `--limit=40` |
