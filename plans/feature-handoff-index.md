...
| | |
|--|--|
| **상태** | **#70 push** tip `08046b49` · PR [#323](https://github.com/catgeot/Days/pull/323) · 화성8경 2 · **#71 용인 결손 오버레이** |
...
| **일지** | [`2026-09-26-project-log.md`](./2026-09-26-project-log.md) |
| **Preview** | `/qa/palgyeong-use` → git Preview `/korea/theme/scenic?hub=hwaseong` 화성8경 2경 용주사 범종·6경 입파홍암 |
