...
| | |
|--|--|
| **상태** | **#64 push** tip `5eb2785b` · PR [#284](https://github.com/catgeot/Days/pull/284) · 무안9경 2 · **#65 보성 결손 오버레이** |
...
| **일지** | [`2026-09-19-project-log.md`](./2026-09-19-project-log.md) |
| **Preview** | `/qa/palgyeong-use` → git Preview `/korea/theme/scenic?hub=muan` 무안9경 3경 식영정과 느러지·5경 톱머리·홀통 |
