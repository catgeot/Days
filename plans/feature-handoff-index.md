...
| | |
|--|--|
| **상태** | **#68 push** tip `fdfc3ff2` · PR [#321](https://github.com/catgeot/Days/pull/321) · 서천9경 2 · **#69 안산 결손 오버레이** |
...
| **일지** | [`2026-09-26-project-log.md`](./2026-09-26-project-log.md) |
| **Preview** | `/qa/palgyeong-use` → git Preview `/korea/theme/scenic?hub=seocheon` 서천9경 8경 장항송림산림욕장과 장항스카이워크·9경 유부도와 서천갯벌 |
