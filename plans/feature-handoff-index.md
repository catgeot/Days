...
| | |
|--|--|
| **상태** | R01–R16 ✅ · **P0·P1 F 소진** · members **578/876** · P2 **null 104** · **P0-P02** ✅ 옥정호 ambiguous · **다음 P0-P03** 칠선시류 ambiguous **1** · A와 **동시 OK** |
| **브랜치** | `cursor/palgyeong-cid` · tip `3392e61e` |
...
| **큐** | [`korea-local-scenic-contentid-queue.md`](./korea-local-scenic-contentid-queue.md) — **P0-P03** 칠선시류 ambiguous **1** |
