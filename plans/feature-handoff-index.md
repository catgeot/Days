...
| | |
|--|--|
| **상태** | R01–R16 ✅ · **P0·P1 F 소진** · members **579/876** · P2 **null 104** · **P0-P03** ✅ 칠선시류 ambiguous · **P0 키워드 종결 소진** · A와 **동시 OK** |
...
| **큐** | [`korea-local-scenic-contentid-queue.md`](./korea-local-scenic-contentid-queue.md) — **P0 inv** 키워드 종결 소진 · null **297** |
