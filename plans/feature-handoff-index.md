...
| | |
|--|--|
| **상태** | **#61 QA push** tip `13ae3ad7` · PR [#279](https://github.com/catgeot/Days/pull/279) · 통영팔경 3 · **#62 경기 광주 결손 오버레이** |
...
| **일지** | [`2026-09-18-project-log.md`](./2026-09-18-project-log.md) |
| **Preview** | `/qa/palgyeong-use` → git Preview `/korea/theme/scenic?hub=tongyeong` 통영팔경 남망산공원·한산도제승당·통영운하 야경 |
