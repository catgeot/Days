...
| | |
|--|--|
| **상태** | **#61 QA push** tip `ff38062f` · PR [#279](https://github.com/catgeot/Days/pull/279) · 통영팔경 3 + QA 1경 U투어·이순신공원 · **#62 경기 광주 결손 오버레이** |
| **브랜치** | `cursor/palgyeong-use-e744` |
| **tip** | `ff38062f` |
| **PR** | [#279](https://github.com/catgeot/Days/pull/279) · [#278](https://github.com/catgeot/Days/pull/278) merge ✅ · [#277](https://github.com/catgeot/Days/pull/277) merge ✅ |
| **플랜** | [`korea-local-scenic-use-plan.md`](./korea-local-scenic-use-plan.md) **§9 A** |
| **일지** | [`2026-09-18-project-log.md`](./2026-09-18-project-log.md) |
| **Preview** | `/qa/palgyeong-use` → git Preview `/korea/theme/scenic?hub=tongyeong` 통영팔경 1경 연화도 용머리·남망산공원·한산도제승당·통영운하 야경 · 홈 이순신공원 |
