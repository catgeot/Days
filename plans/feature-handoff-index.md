...
| | |
|--|--|
| **상태** | R01–R16 ✅ · **P0·P1 F 소진** · members **541/876** · P2 **null 104** · **P0-K10** ✅ · **다음 P0-K11** prefix 잔여 2 · A와 **동시 OK** |
| **브랜치** | `cursor/palgyeong-cid` · tip `1388e038` |
...
| **큐** | [`korea-local-scenic-contentid-queue.md`](./korea-local-scenic-contentid-queue.md) — **P0-K11** prefix 잔여 2 |
