...
| **4** | 출발지·경유지 UI | **v1 ✅** · **v2 ⏳** 검색·내 위치 — [`2026-06-23-project-log.md`](./2026-06-23-project-log.md) Phase 4 v2 |
...
**제시어**: **`항공권-이어하기 @plans/2026-06-23-project-log.md`** — Phase 4 **v2** 출발 검색·내 위치 UI (IATA 칩 제거)
